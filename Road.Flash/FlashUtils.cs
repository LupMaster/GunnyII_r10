...
namespace Road.Flash
{
    ...
    {
        public static XElement CreateFeedbackReplyInfo()
        {
            return new XElement("Item", new object[]
			{
				new XAttribute("QuestionID", ""),
				new XAttribute("ReplyID", 0),
				new XAttribute("OccurrenceDate", System.DateTime.Now),
				new XAttribute("Title", ""),
				new XAttribute("QuestionContent", ""),
				new XAttribute("ReplyContent", ""),
				new XAttribute("StopReply", "")
			});
        }
        ...
        public static XElement CreateItemInfo(ItemTemplateInfo info)
        {
            return new XElement("Item", new object[]
			{
				...
				new XAttribute("FloorPrice", info.FloorPrice),
        ...
        public static XElement CreateUserLoginList(PlayerInfo info)
        {
            return new XElement("Item", new object[]
			{
				...
				new XAttribute("LastDate", System.DateTime.Now)
			});
        }
        public static XElement CreateQuestInfo(QuestInfo info)
        {
            return new XElement("Item", new object[]
			{
				...
				new XAttribute("RewardBindMoney", info.RewardBindMoney),
        ...
        {
            return new XElement("Rate", new object[]
			{
        ...
        public static XElement CreateActiveInfo(ActiveInfo info)
        {
            return new XElement("Item", new object[]
			{
				...
				new XAttribute("HasKey", (info.HasKey == 4) ? 1 : info.HasKey),
				new XAttribute("EndDate", (!info.EndDate.HasValue) ? "" : info.EndDate.Value.ToString("yyyy-MM-dd HH:mm:ss")),
				...
				new XAttribute("Type", info.Type),
				new XAttribute("ActiveType", info.ActiveType),
				...
				new XAttribute("IconID", info.IconID)
			});
        }
        public static XElement CreateAuctionInfo(AuctionInfo info)
        {
            return new XElement("Item", new object[]
			{
				...
				new XAttribute("ValidDate", info.ValidDate),
				new XAttribute("goodsCount", info.goodsCount)
			});
        }
        public static XElement CreateConsortiaInfo(ConsortiaInfo info)
        {
            return new XElement("Item", new object[]
			{
				...
				new XAttribute("ChairmanTypeVIP", info.ChairmanTypeVIP),
				new XAttribute("ChairmanVIPLevel", info.ChairmanVIPLevel),
				new XAttribute("ConsortiaName", (info.ConsortiaName == null) ? "" : info.ConsortiaName),
				...
				new XAttribute("BufferLevel", info.SkillLevel),
				new XAttribute("ConsortiaGiftGp", 940),
				new XAttribute("ConsortiaAddDayGiftGp", 0),
				new XAttribute("ConsortiaAddWeekGiftGp", 8),
				new XAttribute("Port", info.Port),
				new XAttribute("IsVoting", false),
				new XAttribute("VoteRemainDay", 3),
				new XAttribute("CharmGP", 940),
				new XAttribute("BadgeID", info.BadgeID),
				new XAttribute("BadgeBuyTime", System.Convert.ToDateTime(info.BadgeBuyTime).ToString("yyyy-MM-dd HH:mm:ss")),
				new XAttribute("ValidDate", info.ValidDate)
			});
        }
        public static XElement CreateConsortiaApplyUserInfo(ConsortiaApplyUserInfo info)
        {
            return new XElement("Item", new object[]
			{
				...
				new XAttribute("typeVIP", info.typeVIP),
				new XAttribute("IsOld", info.IsOld),
				new XAttribute("FightPower", info.FightPower),
        ...
        public static XElement CreateConsortiaUserInfo(ConsortiaUserInfo info)
        {
            return new XElement("Item", new object[]
			{
				...
				new XAttribute("TotalRichesOffer", info.RichesOffer),
				new XAttribute("LastWeekRichesOffer", 333)
			});
        }
        ...
        {
            System.DateTime.Now.Subtract(info.SendTime);
