...
namespace SqlDataProvider.Data
{
	...
	{
		private Dictionary<int, PetEquipDataInfo> m_peEquip;
		...
		public Dictionary<int, PetEquipDataInfo> EquipList
		{
			get
			{
		...
		public int TotalAttack
		{
			get
			{
				...
				{
					while (i < this.m_peEquip.Count)
					{
						ItemTemplateInfo template = this.m_peEquip[i].Template;
						if (template != null)
						{
							num += template.Attack;
						}
		...
		public Dictionary<int, PetEquipDataInfo> GetEquip()
		{
			...
			{
				if (this.m_peEquip[i].eqTemplateID > 0 && this.m_peEquip[i].IsValidate())
				{
					dictionary.Add(num, this.m_peEquip[i]);
					num++;
				}
			}
			return dictionary;
