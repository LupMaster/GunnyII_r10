...
namespace Game.Server.Packets.Client
{
	...
	public class CaddyClearAllHandler : IPacketHandler
	{
		public int HandlePacket(GameClient client, GSPacketIn packet)
		{
			...
			if (num2 > 0)
			{
				str = LanguageMgr.GetTranslation("ItemReclaimHandler.Success2", new object[]
				{
					num2
				});
			}
			if (num3 > 0)
			{
				str2 = LanguageMgr.GetTranslation("ItemReclaimHandler.Success1", new object[]
				{
					num3
				});
			}
			...
			client.Out.SendMessage(eMessageType.Normal, str + " " + str2);
			return 1;
		}
	}
}
