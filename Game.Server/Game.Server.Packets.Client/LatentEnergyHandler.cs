	...
	public class LatentEnergyHandler : IPacketHandler
	{
		...
		public int HandlePacket(GameClient client, GSPacketIn packet)
		{
			...
			if (num == 1)
			{
				...
				string text = threadSafeRandom.Next(itemTemplateInfo.Property2, itemTemplateInfo.Property3).ToString();
				for (int i = 1; i < 4; i++)
				{
					text = text + "," + threadSafeRandom.Next(itemTemplateInfo.Property2, itemTemplateInfo.Property3).ToString();
				}
