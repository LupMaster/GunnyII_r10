...
namespace Game.Base.Packets
{
	public interface IPacketLib
	{
        ...
        void SendFightFootballTimeActive();
        GSPacketIn SendNewChikenBoxGame(int ID);
        ...
        GSPacketIn SendWonderfulHander(int ID);
        GSPacketIn SendUpdateBuffData(PlayerInfo player);
        GSPacketIn SendbossOpenCloseHandler(int playerid);
