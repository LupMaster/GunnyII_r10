...
namespace Game.Logic
{
	public class DropInventory
	{
		...
		public static bool RetrieveDrop(int user, ref List<ItemInfo> info)
		{
			...
			{
				List<ItemInfo> list = null;
				if (DropInventory.GetDropItems(eDropType.Retrieve, dropCondiction, ref list))
				{
					info = ((list != null) ? list : null);
					return true;
				}
		...
		public static bool GetDrop(int copyId, int user, ref List<ItemInfo> info)
		{
			...
			{
				List<ItemInfo> list = null;
				if (DropInventory.GetDropItems(eDropType.Trminhpc, dropCondiction, ref list))
				{
					info = ((list != null) ? list : null);
					return true;
				}
		...
		public static bool GetPetDrop(int copyId, int user, ref List<PetTemplateInfo> info)
		{
			...
			if (dropCondiction > 0)
			{
				...
				if (DropInventory.GetDropPets(eDropType.Trminhpc, dropCondiction, ref list))
				{
					info = ((list != null) ? list : null);
					return true;
				}
