...
namespace Game.Logic.Phy.Object
{
	public class TurnedLiving : Living
	{
		...
		public override void Reset()
		{
			...
			if (this is Player)
			{
				this.m_delay = 1600 - 1200 * ((Player)this).PlayerDetail.PlayerCharacter.Agility / (((Player)this).PlayerDetail.PlayerCharacter.Agility + 1200) + ((Player)this).PlayerDetail.PlayerCharacter.Attack / 10;
				return;
			}
		...
		public override void PrepareSelfTurn()
		{
			...
			if (base.IsFrost)
			{
				if (this is Player)
				{
					this.AddDelay(1600 - 1200 * ((Player)this).PlayerDetail.PlayerCharacter.Agility / (((Player)this).PlayerDetail.PlayerCharacter.Agility + 1200) + ((Player)this).PlayerDetail.PlayerCharacter.Attack / 10);
				}
				else
				{
					this.AddDelay((this as SimpleBoss).NpcInfo.Delay);
				}
			}
