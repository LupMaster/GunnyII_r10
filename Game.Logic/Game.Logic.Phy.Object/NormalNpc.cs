                ...
                if (infos != null)
                {
                    foreach (SqlDataProvider.Data.ItemInfo info in infos)
                    {
                        ...
                        if (info != null)
                        {
                            ...
                            {
                                p.PlayerDetail.AddTemplate(info, eBageType.FightBag, info.Count, eItemNotice.GoodsTipBroadcastTypeView, eItemNotice.GoodsTipBroadcastTypeView);
                            }
                            else
                            {
                                p.PlayerDetail.AddTemplate(info, eBageType.TempBag, info.Count, eItemNotice.GoodsTipBroadcastTypeView, eItemNotice.GoodsTipBroadcastTypeView);
                            }
                        }
                    }
