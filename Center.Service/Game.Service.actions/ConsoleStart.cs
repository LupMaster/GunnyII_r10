...
namespace Game.Service.actions
{
	public class ConsoleStart : IAction
	{
		...
		{
			System.Console.WriteLine("Iniciando Servidor.");
			return CenterServer.Instance.Start();
		}
		public void OnAction(System.Collections.Hashtable parameters)
		{
            Console.Title = "ĐĐŦΔŇҜ (αłяєα∂y ıη ѵєяsıση 14)";
			System.Console.WriteLine("DDTank editado e fixado por Jhonetec!");
			System.Console.WriteLine("Iniciando Center.Service... Aguarde um momento!");
