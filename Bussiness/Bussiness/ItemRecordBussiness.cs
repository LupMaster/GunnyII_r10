...
namespace Bussiness
{
    public class ItemRecordBussiness : BaseBussiness
    {
        ...
        public bool LogItemDb(DataTable dt)
        {
            ...
            catch (Exception ex)
            {
                if (BaseBussiness.log.IsErrorEnabled)
                    BaseBussiness.log.Error((object)("Smith Log Error:" + ((object)ex).ToString()));
            }
            finally
            {
                sqlBulkCopy.Close();
        ...
        public bool LogFightDb(DataTable dt)
        {
            ...
            {
                if (BaseBussiness.log.IsErrorEnabled)
                    BaseBussiness.log.Error((object)("Fight Log Error:" + ((object)ex).ToString()));
            }
            finally
            {
                sqlBulkCopy.Close();
        ...
        public bool LogDropItemDb(DataTable dt)
        {
            ...
            {
                if (BaseBussiness.log.IsErrorEnabled)
                    BaseBussiness.log.Error((object)("DropItem Log Error:" + ((object)ex).ToString()));
            }
            finally
            {
                sqlBulkCopy.Close();
        ...
        public bool LogServerDb(DataTable dt)
        {
            ...
            {
                if (BaseBussiness.log.IsErrorEnabled)
                    BaseBussiness.log.Error((object)("Server Log Error:" + ((object)ex).ToString()));
            }
            finally
            {
                sqlBulkCopy.Close();
