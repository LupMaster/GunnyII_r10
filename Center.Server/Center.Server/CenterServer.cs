...
namespace Center.Server
{
    public class CenterServer : BaseServer
    {
        ...
        public bool InitGlobalTimers()
        {
            ...
            num = this._config.SystemNoticeInterval * 60 * 1000;
            if (this.m_sytemNotice == null)
            {
                this.m_sytemNotice = new Timer(new TimerCallback(this.SystemNoticeTimerProc), null, num, num);
            }
            else
            {
                this.m_sytemNotice.Change(num, num);
            }
